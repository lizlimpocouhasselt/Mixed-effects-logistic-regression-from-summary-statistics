...
sapply(1:nrow(par_settings), function(row){
    ...
    # Load summary data
    load(sprintf(file.path("SIMULATION", "intermediate_results", "orig_setting", "mean_cov", 
                            "mean_cov_%04d_%04d_%04d.RData"), iter, m, uniform_cluster_size))
    load(sprintf(file.path("SIMULATION", "intermediate_results", "orig_setting", "var_cov_mat", 
    ...
    load(sprintf(file.path("SIMULATION", "intermediate_results", "orig_setting",
     "mv_moment_3_4_by3_df", "mv_moment_3_4_by3_df_%04d_%04d_%04d.RData"), 
                            iter, m, uniform_cluster_size))
    load(sprintf(file.path("SIMULATION", "intermediate_results", "orig_setting", "mv_moment_4_df", 
    ...
    # Save pseudo-data
    filename_save <- sprintf(file.path("SIMULATION", "intermediate_results", "orig_setting",
