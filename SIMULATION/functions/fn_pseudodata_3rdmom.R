...
fn_pseudodata_3rdmom_glmm <- function(iter, m, y_name, uniform_cluster_size, seed, names_ind_vars, 
  ...
  pseudo_data_3rd_mom <- lapply(1:m, function(group_num){
    ...
    for(name_ind in names_ind_vars){
      ...
      print(paste0('iter ', iter, '; ', 'grp ', group_num, '; ',
       'syn_df_3rd_mom; ', name_ind, ' is finished'))
    }
