#-------------------------------------------------------------------
# FIGURE 7: BIAS DISTRIBUTION AND COVERAGE UNDER MISSPECIFIED
...
# Call function/s
source(file.path("Figures", "scripts_and_functions", "fn_figure_7_mis_2.R"))
...
postscript(file.path("Figures", "outputs", "fig7a_bias_mis_2.eps"))
...
postscript(file.path("Figures", "outputs", "fig7b_coverage_mis_2.eps"))
