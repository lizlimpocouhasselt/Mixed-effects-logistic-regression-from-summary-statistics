...
postscript(file.path("Figures", "outputs", "fig3_ci_all_1.eps"), onefile = F)
plot_grid(plotlist = ci_allpars[1:3], ncol = 1)
postscript(file.path("Figures", "outputs", "fig3_ci_all_2.eps"), onefile = F)
plot_grid(plotlist = ci_allpars[4:6], ncol = 1)
dev.off()
