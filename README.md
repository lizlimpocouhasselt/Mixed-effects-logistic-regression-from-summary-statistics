...
## Description
This README demonstrates (via R) the concepts explained in our paper entitled [Federated mixed effects logistic regression based on one-time shared summary statistics](https://arxiv.org/abs/2407.20796), although these can be implemented in any other statistical softwares.
