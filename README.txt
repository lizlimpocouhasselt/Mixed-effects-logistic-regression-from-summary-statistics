...
#---------------------------------------------------------------------------------------------------
# OPERATING SYSTEM VERSION AND VERSION INFO FOR STATISTICAL LIBRARIES
#---------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------
# LISTING OF FILES AND FOLDERS STRUCTURE
#---------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------
# CONCRETE EXAMPLES OF IMPLEMENTATION (TOP-BOTTOM APPROACH)
#---------------------------------------------------------------------------------------------------

EXAMPLE 1: REPRODUCING FIGURE 2 (BIAS DISTRIBUTION PLOTS FOR ORIGINAL SETTING)
figure :                Figures/outputs/fig2_bias.eps

script/s :              Figures/scripts_and_functions/figure_2_bias_distribution.R

function/s :            Figures/scripts_and_functions/fn_figure_2_bias_distribution.R


To reproduce the bias distribution plots in Figure 2, we need to generate point estimates (intermediate result/s) through the script "estimates.R", which has a function "fn_estimate_helper.R" that helps organize the results:

intermediate result/s : SIMULATION/intermediate_results/orig_setting/point_estimates

script/s :              SIMULATION/scripts/orig_setting/estimates.R

function/s :            SIMULATION/functions/fn_estimate_helper.R


To reproduce a single point_estimates file, we need the simdata and pseudodata files (ps2, ps3, and ps4) which can be generated using the scripts "simdata.R", "pseudodata_2ndmom.R", "pseudodata_3rdmom.R", and "pseudodata_4thmom.R":
intermediate result/s : SIMULATION/intermediate_results/orig_setting/simdata,
						SIMULATION/intermediate_results/orig_setting/ps2,
						SIMULATION/intermediate_results/orig_setting/ps3,
						SIMULATION/intermediate_results/orig_setting/ps4

script/s :              SIMULATION/scripts/orig_setting/simdata.R,
		                SIMULATION/scripts/orig_setting/pseudodata_2ndmom.R,
		                SIMULATION/scripts/orig_setting/pseudodata_3rdmom.R,
		                SIMULATION/scripts/orig_setting/pseudodata_4thmom.R

function/s :            SIMULATION/functions/fn_simdata.R,
						SIMULATION/functions/fn_pseudodata_2ndmom.R,
						SIMULATION/functions/fn_pseudodata_3rdmom.R,
						SIMULATION/functions/fn_pseudodata_4thmom.R,
						SIMULATION/functions/gen_pseudo.R,
						SIMULATION/functions/lsqnonlin_2.R


To reproduce a single set of pseudodata (ps2, ps3, and ps4), we need the summary information files (mean_cov, etc.) which can be generated by running "compute_summary.R":
intermediate result/s : SIMULATION/intermediate_results/orig_setting/mean_cov,
						SIMULATION/intermediate_results/orig_setting/var_cov_mat,
						SIMULATION/intermediate_results/orig_setting/mv_moment_3_4_bypair_df,
						SIMULATION/intermediate_results/orig_setting/mv_moment_3_4_by3_df,
						SIMULATION/intermediate_results/orig_setting/mv_moment_4_df

script/s :              SIMULATION/scripts/orig_setting/compute_summary.R

function/s :            SIMULATION/functions/fn_compute_summary.R


To reproduce a single set of summary information (mean_cov, etc.), we need to simulate data (simdata) by running "simdata.R": 
intermediate result/s : SIMULATION/intermediate_results/orig_setting/simdata
...
EXAMPLE 2: REPRODUCING FIGURE 6 (BIAS DISTRIBUTION AND COVERAGE PLOTS FOR MISSPECIFIED SETTING)
figure :                Figures/outputs/fig6a_bias_mis_0.eps,
						Figures/outputs/fig6b_coverage_mis_0.eps

script/s :              Figures/scripts_and_functions/figure_6_mis_0.R

function/s :            Figures/scripts_and_functions/fn_figure_6_mis_0.R


To reproduce the plots in Figure 6, we need to generate point and interval estimates (intermediate result/s) through the script "estimates.R", which has a function "fn_estimate_helper.R" that helps organize the results:

intermediate result/s : SIMULATION/intermediate_results/mis_0/point_estimates,
						SIMULATION/intermediate_results/mis_0/interval_estimates

script/s :              SIMULATION/scripts/mis_0/estimates.R

function/s :            SIMULATION/functions/fn_estimate_helper.R


To reproduce a pair of point_estimates and interval_estimates files, we need the simdata and pseudodata files (ps2, ps3, and ps4) which can be generated using the scripts "simdata.R", "pseudodata_2ndmom.R", "pseudodata_3rdmom.R", and "pseudodata_4thmom.R":
intermediate result/s : SIMULATION/intermediate_results/mis_0/simdata,
						SIMULATION/intermediate_results/mis_0/ps2,
						SIMULATION/intermediate_results/mis_0/ps3,
						SIMULATION/intermediate_results/mis_0/ps4

script/s :              SIMULATION/scripts/mis_0/simdata.R,
		                SIMULATION/scripts/mis_0/pseudodata_2ndmom.R,
		                SIMULATION/scripts/mis_0/pseudodata_3rdmom.R,
		                SIMULATION/scripts/mis_0/pseudodata_4thmom.R
...
To reproduce a single set of pseudodata (ps2, ps3, and ps4), we need the summary information files (mean_cov, etc.) which can be generated by running "compute_summary.R":
intermediate result/s : SIMULATION/intermediate_results/mis_0/mean_cov,
						SIMULATION/intermediate_results/mis_0/var_cov_mat,
						SIMULATION/intermediate_results/mis_0/mv_moment_3_4_bypair_df,
						SIMULATION/intermediate_results/mis_0/mv_moment_3_4_by3_df,
						SIMULATION/intermediate_results/mis_0/mv_moment_4_df

script/s :              SIMULATION/scripts/mis_0/compute_summary.R
